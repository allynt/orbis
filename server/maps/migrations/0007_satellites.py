...
import maps.models.models_satellites
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('thumbnail', models.FileField(blank=True, help_text='A thumbnail image representing this bookmark.', null=True, upload_to=maps.models.models_satellites.visualisation_thumbnail_path)),
            ],
        ),
        migrations.CreateModel(
            name='SatelliteScene',
            fields=[
                ...
                ('properties', django.contrib.postgres.fields.jsonb.JSONField(blank=True, help_text='Some more information to associate with the scene.', null=True, validators=[maps.models.models_satellites.validate_properties])),
                ('urls', django.contrib.postgres.fields.jsonb.JSONField(blank=True, null=True, validators=[maps.models.models_satellites.validate_urls])),
