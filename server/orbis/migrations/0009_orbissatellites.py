    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'satellite_id',
                    models.SlugField(
                        help_text='A unique id for the satellite.', unique=True
                    )
                ),
                (
                    'title',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'name',
                    models.SlugField(
                        help_text='A unique name for the resolution.',
                        unique=True
                    )
                ),
                (
                    'title',
                    models.CharField(
                        help_text='A pretty display name for the resolution.',
                        max_length=128
                    )
                ),
                (
                    ...
                    models.TextField(
                        blank=True,
                        help_text='A description of the resolution.',
                        null=True
                    )
                ),
                (
            ...
            fields=[
                ...
                (
                    ...
                    models.FileField(
                        ...
                        null=True,
                        upload_to="satellites/visualisations"
                    )
                ),
            ],
            options={
            ...
            fields=[
                ...
                (
                    ...
                    models.ManyToManyField(
                        ...
                        to='orbis.SatelliteResolution'
                    )
                ),
                (
                    'satellites',
                    models.ManyToManyField(
                        related_name='searches', to='orbis.Satellite'
                    )
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    'scene_id',
                    models.SlugField(help_text='A unique id for the scene.')
                ),
                (
                    'thumbnail',
                    models.URLField(
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(
                blank=True,
                related_name='satellites',
                to='orbis.SatelliteVisualisation'
            ),
        ),
