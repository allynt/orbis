...
import { selectDataToken, selectFilteredData, selectNonUserLayers } from '../data-layers/data-layers.slice';
...
const Map = ({
  ...
  const nonSelectedLayers = useSelector(selectNonUserLayers);
