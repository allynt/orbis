          ...
          <ul className={styles.list}>
            ...
            <li className={styles.listItem}>
              ...
              <div>
                ...
                generality the graphical user interface and/or menu command
                hierarchy);
              </div>
            </li>
            <li className={styles.listItem}>
            ...
            <li className={styles.listItem}>
              <span>2.7.</span>
              <div>
                use the Subscription Services in a way that violates any
            ...
            <li className={styles.listItem}>
              <span>2.8.</span>
              <div>
                load test the Subscription Services in order to test
                scalability; or,
              </div>
            </li>
            <li className={styles.listItem}>
          ...
          <ul className={styles.list}>
            <li className={styles.listItem}>
              ...
              <div>
                ...
                as specified in Clause 4. The Customer is solely responsible for
            ...
            <li className={styles.listItem}>
              ...
              <div>
                ...
                makes no claim to any right of ownership in User Content except
                ...
                <ul className={styles.list}>
                  <li className={styles.listItem}>
                    ...
                    <div>
                      ...
                      Services, and make recommendations for improved usage of
                  ...
                  <li className={styles.listItem}>
                    ...
                    <div>
                      ...
                      centre containing the User Content complies with ISO
                      27001.
                    </div>
                  </li>
                </ul>
            ...
            <li className={styles.listItem}>
              ...
              <div>
                ...
                of the Legislation (except in the case of Data Sharing in terms
                of Clause 22), Astrosat will be a Data Processor and the
                Customer will be the Data Controller of User Content. This
                clause is in addition to, and does not relieve, remove or
                replace, Astrosat’s obligations or rights under the Privacy
                Legislation.
              </div>
            </li>
            <li className={styles.listItem}>
              <span>3.6.</span>
              <div>
                Sharing of login/account details is not permitted unless
                expressly authorised in writing by Astrosat. Users must keep
                login/account details confidential and Users should not reveal
                their username or password to any unauthorised third parties.
                ...
                save login/account details in their internet browser.
              </div>
            </li>
            <li className={styles.listItem}>
              <span>3.7.</span>
            ...
            <li className={styles.listItem}>
              ...
              <div>
                ...
                strong, robust, difficult to break passwords, that are changed
                on a regular basis; (c) that Users do not save login/account
                details in their internet browser; and (d) implementing two
                factor authentication at each endpoint.
              </div>
            </li>
            <li className={styles.listItem}>
              <span>3.9.</span>
    ...
    <div className={styles.content}>
      ...
      <div className={styles.body}>
        ...
        <div className={styles.infoContainer}>
          {info === TERMS && <Terms onClick={() => setInfo(PRIVACY_POLICY)} />}
