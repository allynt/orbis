  ...
  <div className={styles.quickView}>
    <div className={styles.content}>
      <div className={styles.column}>
        <h2 data-testid="active" className={styles.value}>
          {licenceData.active}
        </h2>
        <h3 className={styles.title}>Active Users</h3>
      </div>
      <div className={styles.column}>
        <h2 data-testid="pending" className={styles.value}>
          {licenceData.pending}
        </h2>
        <h3 className={styles.title}>Pending Invitations</h3>
      </div>
      <div className={styles.column}>
        <h2 data-testid="available" className={styles.value}>
          {licenceData.available}
        </h2>
