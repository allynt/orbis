 ...
 * @property {import('typings').Dashboard[]} [dashboards]
 * @property {any} [error]
...
/**
 * @type {import('@reduxjs/toolkit').AsyncThunk<import('typings').Dashboard[], undefined, {}>}
 */
export const fetchDashboards = createAsyncThunk(
  `${name}/fetchBookmarks`,
  async (_, { rejectWithValue }) => {
    try {
      return await apiClient.dashboards.getDashboard();
    } catch (error) {
