...
const Terms = ({ onClick }) => (
  <div className={styles.text}>
    ...
    <div className={styles.description}>
      ...
      must click to accept these Terms and Conditions. If the Customer does not
      agree to be bound by these Terms and Conditions, the Customer cannot order
      or use any Subscription Services or any Professional Services. The
    ...
    <div className={styles.description}>
      ...
      contractual offer and the Customer’s signing/acceptance of these Terms and
      Conditions and acceptance/signing of an Order Form will conclude the
    ...
    <div className={styles.section}>
      ...
      <div className={styles.description}>
        ...
        Customer fails to do this, Astrosat shall be relieved of its obligations
        to the extent that the obligations are dependent upon the Customer’s
        performance.
      </div>
    </div>
    <div className={styles.title}>
    ...
    <div className={styles.section}>
      ...
      <div className={styles.description}>
        ...
        for the relevant services and ends when Astrosat no longer is obliged to
        provide the Customer with Subscription Services or Professional Services
    ...
    <div className={styles.section}>
      <h2 className={styles.textSectionHeader}>15: Limitation of Liability.</h2>
      <div className={styles.description}>
        <ul className={styles.list}>
          <li className={styles.listItem}>
            <span>15.1.</span>
    ...
    <div className={styles.section}>
      ...
      <div className={styles.description}>
        Astrosat may list the Customer as a customer and use the Customer’s logo
        on Astrosat’s website, on publicly available Customer lists, and in
        media releases with the Customer’s consent, such consent not to be
    ...
    <div className={styles.section}>
      ...
      <div className={styles.description}>
        ...
        services in accordance with these Service Levels and Response Times.
        These Response times refer only to the time within which Astrosat shall
        respond to a helpdesk support request. Astrosat gives no guarantee as to
        the time any given issue may take to resolve save that it hereby
        undertakes to use reasonable endeavours to resolve issues as quickly as
        is reasonably possible within the target resolution times specified in
        the table above.
      </div>
    </div>
    <div className={styles.section}>
    ...
    <div className={styles.description}>
      ...
      Agreement entered into between Astrosat and the Customer dated xxxxx (the{' '}
    ...
    <div className={styles.section}>
      ...
      <div className={styles.description}>
        ...
        be bound by all the terms and conditions of the Agreement and this Order
        Form. The use of any approved Sub-contractor or Affiliate by Astrosat
        will not absolve Astrosat of its contractual obligations to the Customer
        under the Agreement and Astrosat shall be liable to the Customer for the
        work carried out by any such Sub-contractor or Affiliate as if Astrosat
        had carried out such work itself. Any Sub-contractors or consultants
        (other than Astrosat’s Affiliates) that will be used by Astrosat in
        performing the Services are listed below:
      </div>
      <div className={styles.description}>
      ...
      <div className={styles.description}>
        <ul className={styles.list}>
          ...
          <li className={styles.listItem}>
            <span>14.11.</span>
            <div>
              <strong>“Privacy Policy”</strong> means Stevenson Astrosat’ policy
              relating to User Content and compliance with (amongst others) the
              DPA and the GDPR from time to time, the current version of which
              is located{' '}
