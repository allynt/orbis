...
const Terms = ({ onClick }) => {
  ...
  return (
    <div className={styles.text}>
      ...
      <p>
        This agreement is between <b>STEVENSON ASTROSAT LIMITED</b> a company
        incorporated in Scotland (Number SC423073) and whose Registered Office
        is at Copernicus Kirk, 200 High Street, Musselburgh EH21 7DX
      ...
      <h1 className={styles.title}>PART ONE – SUBSCRIPTION SERVICES.</h1>
      <h2 className={styles.textSectionHeader}>1: Grant of Licence.</h2>
      <div className={styles.description}>
        Astrosat grants to the Customer a non-exclusive, royalty based (i.e. the
        fees specified in the Order Form), non-sublicensable, term licence to
        Use the Subscription Services for the Customer’s internal business
        purposes for the Subscription Term, subject to the following conditions:
        <ul className={styles.list}>
          <li className={styles.listItem}>
            <span>1.1.</span>
            <div>
          ...
          <li className={styles.listItem}>
            <span>1.2.</span>
            <div>
              Users must have a reasonable speed Internet connection, and Local
              Equipment that is compatible with the Subscription Services, as
              set out in the Documentation. None of these things are Astrosat’s
              responsibility.
            </div>
          </li>
          <li className={styles.listItem}>
            ...
            <div>
              ...
              Some of these changes shall occur automatically, while others may
              require the Customer to schedule and implement the changes. The
              changes may also mean that Users need to upgrade their Local
          ...
          <li className={styles.listItem}>
            <span>1.4.</span>
            <div>
              Astrosat has all required distribution rights to the Intellectual
              Property in the Software and the Documentation.
            </div>
          </li>
          <li className={styles.listItem}>
            <span>1.5.</span>
            <div>
              Neither party shall be under any liability to the other in respect
              of anything which, apart from this provision, may constitute
          ...
          <ul className={styles.list}>
            <li className={styles.listItem}>
              ...
              <div>
                ...
                Site(s) belong(s) unless it is expressly stated otherwise in
                this Agreement.
              </div>
            </li>
            <li className={styles.listItem}>
              ...
              <div>
                ...
                therein belongs to third parties.
              </div>
            </li>
            <li className={styles.listItem}>
              <span>6.3.</span>
          ...
          <ul className={styles.list}>
            ...
            <li className={styles.listItem}>
              ...
              <div>
                ...
                Documentation or unless given express written permission to do
          ...
          <ul className={styles.list}>
            <li className={styles.listItem}>
              ...
              <div>
                ...
                (ii) Astrosat owns or otherwise has the right to provide the
            ...
            <li className={styles.listItem}>
              ...
              <div>
                ...
                accordance with the Documentation, Astrosat shall, at its
                option, either (i) modify the Subscription Services to conform
                to the Documentation; or (ii) provide a workaround solution that
                will reasonably meet the Customer’s requirements. If neither of
                these options are commercially feasible, either party may
                terminate the relevant Order Form under this Agreement, in which
                case Astrosat shall refund to the Customer all fees pre-paid to
                Astrosat under the relevant Order Form for unused Subscription
                Services. If the normal operation, possession or use of the
                Subscription Services by the Customer is found to infringe any
                third party Intellectual Property right or Astrosat believes
                that this is likely, Astrosat shall, at its option, either (i)
                obtain a license from such third party for the benefit of the
                Customer; (ii) modify the Subscription Services so that they no
                longer infringe; or (iii) if neither of these options are
                commercially feasible, terminate the relevant Order Form under
                this Agreement, in which case Astrosat shall refund to the
                Customer all fees pre-paid to Astrosat under the relevant Order
                Form for unused Subscription Services.
              </div>
            </li>
            <li className={styles.listItem}>
              <span>8.3.</span>
                ...
                <ul className={styles.list}>
                  ...
                  <li className={styles.listItem}>
                    ...
                    <div>
                      ...
                      Third-Party Software or hardware, by accidental damage or
                      by other matters beyond Astrosat’s reasonable control.
                    </div>
                  </li>
                </ul>
              </div>
      ...
      <h1 className={styles.title}>PART TWO – PROFESSIONAL SERVICES.</h1>
      <div className={styles.section}>
        <h2 className={styles.textSectionHeader}>
          ...
          <ul className={styles.list}>
            <li className={styles.listItem}>
              ...
              <div>
                ...
                care and diligence. The remedies set out in this Clause 9 are
                the Customer’s exclusive remedies for breach of either warranty.
                If the Professional Services do not conform to the Order Form or
                are not performed with reasonable skill, care and diligence,
                Astrosat shall re-perform the Professional Services to the
                extent necessary to correct the defective performance.
              </div>
            </li>
            <li className={styles.listItem}>
              <span>9.2.</span>
              <div>
                Astrosat shall comply with the terms of the SLA (or as amended
                in an Order Form) at all times. The terms of Clause 9.1 shall
                apply to the SLA.
              </div>
            </li>
          </ul>
      ...
      <h1 className={styles.title}>PART THREE – GENERAL.</h1>
      <div className={styles.section}>
        ...
        <div className={styles.description}>
          <ul className={styles.list}>
            <li className={styles.listItem}>
              <span>12.1.</span>
              <div>
                The Customer shall pay the fees listed in, and in accordance
                with, the relevant Order Form.
              </div>
            </li>
            <li className={styles.listItem}>
              <span>12.2.</span>
              <div>
                ...
                term, and subsequently orders an additional product, the
                purchase price for the additional product shall be pro-rated so
                that the added subscriptions terminate on the same day as the
                initial Subscription Term (unless specified otherwise in the
                relevant Order Form).
              </div>
            </li>
            <li className={styles.listItem}>
              <span>12.3.</span>
              <div>
                The fees for the initial Subscription Term (stated in the
                relevant Order Form) will be as specified in the Order Form.
                Astrosat reserves the right to change fees from time to time and
                any such changes may affect the Customer’s recurring fees after
                the initial Subscription Term. Increases in price will be
                reflected in the Customer’s recurring fees for the Services.
              </div>
            </li>
          </ul>
        </div>
          ...
          <ul className={styles.list}>
            <li className={styles.listItem}>
              ...
              <div>
                ...
                particular Order Form at any time after expiry of the
                Subscription Term and provided all outstanding fees have been
                paid to the party providing the services by providing 30 days’
              ...
              <div>
                ...
                <ul className={styles.list}>
                  ...
                  <li className={styles.listItem}>
                    <span>13.2.2.</span>
                    <div>
                      the other party is unable to pay its debts and/or ceases
                      to trade and/or suffers an Insolvency Event.
                    </div>
                  </li>
                </ul>
              </div>
            ...
            <li className={styles.listItem}>
              <span>13.3.</span>
              <div>
                Sections 2.4, 2.5, 3.3, 4, 5, 6, 7, 8, 11, 13, 14, 15, 16, 17,
                18, 20, 21, 22, 23, 24 and 25 shall continue after this
                Agreement ends.
              </div>
            </li>
            <li className={styles.listItem}>
              <span>13.4.</span>
              <div>
                If Astrosat terminates an Order Form under this Agreement
                because of non-payment by the Customer, all unpaid fees for the
                remainder of the Subscription Term immediately fall due for
                payment.
              </div>
            </li>
            <li className={styles.listItem}>
                ...
                <ul className={styles.list}>
                  <li className={styles.listItem}>
                    ...
                    <div>
                      ...
                      Astrosat can provide a User Content recovery service to
                      the Customer, should they wish to use it. Astrosat
                      reserves the right to charge for this service; and
                    </div>
                  </li>
                  <li className={styles.listItem}>
                    <span>13.5.2.</span>
                    <div>
                      ...
                      invoice has been raised and any work in progress. Each
                      party shall invoice the other and the invoice shall be
            ...
            <li className={styles.listItem}>
              ...
              <div>
                ...
                termination, including the right to claim damages (subject to
                the limitations contained herein) in respect of any breach of
                this Agreement or any Order Form that existed at or before the
                date of termination.
              </div>
            </li>
            <li className={styles.listItem}>
              <span>13.7.</span>
              <div>
                Astrosat may retain User Content in backup media for an
                additional period of up to one year after the date of
                termination of this Agreement, or longer if required by law,
                provided it makes no further use of such User Content (except as
                provided for herein or as is required by law), keeps the User
                Content confidential in accordance with Clause 16, and supplies
                the Customer with a copy of the most recent back-up of the User
                Content within 30 days of the Customer’s request (at the
                Customer’s cost).
              </div>
            </li>
          </ul>
          ...
          <ul className={styles.list}>
            <li className={styles.listItem}>
              ...
              <div>
                ...
                Services, Software and Professional Services are provided with
                no other warranties of any kind, and Astrosat disclaims all
                other warranties, express or implied, including without
                limitation any warranty of merchantability or fitness for a
                particular purpose. Astrosat does not warrant that the use of
                the Subscription Services shall be uninterrupted or error-free.
              </div>
            </li>
          </ul>
        </div>
          ...
          <ul className={styles.list}>
            <li className={styles.listItem}>
              ...
              <div>
                ...
                The Customer assumes all responsibility for the selection of the
                Subscription Services, Software and Documentation necessary to
                achieve the Customer’s intended results, and for the use and
                results of the Subscription Services or work product. Each
                party’s total liability for any direct loss, cost, claim or
                damages of any kind related to this Agreement or the relevant
                Order Form shall not exceed the amount of the fees paid or
                payable by the relevant party under such relevant Order Form
                during the period of 12 months before the event giving rise to
                such loss, cost, claim or damages. However, there is no
                limitation on direct loss, claim or damages arising as a result
                of an infringement of either party’s Intellectual Property
                rights by the other party, or a breach of Clause 16 or Clauses
                21 and 22 of this Agreement by the other party.
              </div>
            </li>
            <li className={styles.listItem}>
              <span>15.2.</span>
              <div>
                ...
                limitation shall not apply to a breach of Clauses 21 or 22.
              </div>
            </li>
          </ul>
        </div>
          ...
          <ul className={styles.list}>
            <li className={styles.listItem}>
              ...
              <div>
                ...
                subsequently becomes, through no act or failure to act on the
                part of receiving party (the “Receiver”), generally known or
                ...
                disclosure; or (iv) is required to be disclosed by law, provided
                that the party to whom the information belongs is given prior
                written notice of any such proposed disclosure.
              </div>
            </li>
            <li className={styles.listItem}>
              <span>16.2.</span>
            ...
            <li className={styles.listItem}>
              ...
              <div>
                ...
                accordance with this clause 16.4, it takes into account the
            ...
            <li className={styles.listItem}>
              <span>16.6.</span>
              <div>
                This clause 16 shall survive termination of this Agreement or
          ...
          <ul className={styles.list}>
            <li className={styles.listItem}>
              ...
              <div>
                ...
                clients, its Affiliates, directors and employees from any
                ...
                legal action alleging that the use of the Subscription Services
                or Documentation by the Customer (other than User Content – see
                Clauses 4 and 18) infringes the Intellectual Property of any
                third party, (“Legal Action”). Astrosat shall provide reasonable
            ...
            <li className={styles.listItem}>
              ...
              <div>
                ...
                not supplied, or approved in writing by Astrosat; (ii) any
                repair, adjustment, modification or alteration to the
                Subscription Services by the Customer or any third party, unless
                approved in writing by Astrosat; or (iii) any refusal by the
                Customer to install and use a non-infringing version of the
                Subscription Services offered by Astrosat under Clause 8.2(ii).
                Clause 8.2(ii) and this Clause 17 state the entire liability of
                Astrosat with respect to any Intellectual Property infringement
                by the Subscription Services or Software or Documentation.
              </div>
            </li>
            <li className={styles.listItem}>
              <span>17.3.</span>
              <div>
                ...
                Legal Action. The Customer shall give Astrosat the sole control
                of the defence of any Legal Action, shall act in accordance with
                the reasonable instructions of Astrosat and shall give Astrosat
                such assistance as Astrosat reasonably requests to defend or
                settle such claim. Astrosat shall conduct its defence at all
                times in a manner that is not adverse to the Customer’s
                interests. the Customer may employ its own counsel to assist it
                with respect to any such claim. The Customer shall bear all
                costs of engaging its own counsel, unless engagement of counsel
                is necessary because of a conflict of interest with Astrosat or
                its counsel, or because Astrosat fails to assume control of the
                defence. The Customer shall not settle or compromise any Legal
                Action without Astrosat’s express written consent. Astrosat
                shall be relieved of its indemnification obligation under Clause
                17 if the Customer materially fails to comply with Clause 17.3.
              </div>
            </li>
          </ul>
        </div>
          ...
          <ul className={styles.list}>
            ...
            <li className={styles.listItem}>
              ...
              <div>
                ...
                communications, notices and/or other actions relating to the
                Legal Claim. Astrosat shall give the Customer the sole control
                of the defence of any Legal Claim, shall act in accordance with
                the reasonable instructions of the Customer and shall give the
                ...
                assist it with respect to any such claim. Astrosat shall bear
                all costs of engaging its own counsel, unless engagement of
                counsel is necessary because of a conflict of interest with the
                Customer or its counsel, or because the Customer fails to assume
                control of the defence. Astrosat shall not settle or compromise
                any Legal Claim without the Customer’s express written consent.
                The Customer shall be relieved of its indemnification obligation
                under Clause 18 if Astrosat materially fails to comply with
                Clause 18.2.
              </div>
            </li>
          </ul>
        ...
        <div className={styles.description}>
          <ul className={styles.list}>
            ...
            <li className={styles.listItem}>
              <span>20.4.</span>
              <div>
                Neither party shall assign or otherwise transfer any of its
        ...
        <div className={styles.description}>
          <ul className={styles.list}>
            ...
            <li className={styles.listItem}>
              <span>21.2.</span>
              <div>
                The provisions of this Agreement shall apply to the processing
                of the Personal Data carried out for the Customer by Astrosat,
                and to all Personal Data held by Astrosat in relation to all
                such processing whether such Personal Data is held at the date
                of this Agreement or received afterwards.
              </div>
            </li>
            <li className={styles.listItem}>
              <span>21.3.</span>
              <div>
                This Agreement shall continue in full force and effect for so
                long as Astrosat is processing Personal Data on behalf of the
                Customer.
              </div>
            </li>
            <li className={styles.listItem}>
              ...
              <div>
                ...
                <ul className={styles.list}>
                  ...
                  <li className={styles.listItem}>
                    <span>21.4.2.</span>
                    <div>
                      to the extent and in such a manner as is necessary for
                      those purposes; and
                    </div>
                  </li>
                  <li className={styles.listItem}>
                    <span>21.4.3.</span>
                    <div>
                      strictly in accordance with the Agreement or otherwise
                      with the express written authorisation and instructions of
                      the Customer (which may be specific instructions or
                      instructions of a general nature or as otherwise notified
                      by the Customer to Astrosat).
                    </div>
                  </li>
                </ul>
              </div>
            ...
            <li className={styles.listItem}>
              ...
              <div>
                ...
                by Astrosat, the duration of processing and the types of
            ...
            <li className={styles.listItem}>
              ...
              <div>
                ...
                and other applicable laws. Astrosat shall act only on such
                written instructions from the Customer unless Astrosat is
                required by law to do otherwise (as per Article 29 of the GDPR).
              </div>
            </li>
            <li className={styles.listItem}>
              <span>21.7.</span>
              <div>
                ...
                cannot do this itself via the Subscription Services) in
                complying with a legitimate data subject request to amend,
                transfer, delete, or otherwise dispose of Personal Data. Where
                permitted to do so by law, Astrosat may charge a reasonable fee
            ...
            <li className={styles.listItem}>
              ...
              <div>
                ...
                applicable laws and shall not perform their obligations under
                this Agreement or any other agreement or arrangement between
                themselves in such way as to cause either party to breach any of
                its applicable obligations under the GDPR.
              </div>
            </li>
            <li className={styles.listItem}>
              <span>21.9.</span>
              <div>
                ...
                the Personal Data shall comply with the GDPR in all respects
            ...
            <li className={styles.listItem}>
              <span>21.10.</span>
              <div>
                Astrosat agrees to comply with any reasonable measures required
                by the Customer to ensure that its obligations under this
                Agreement are satisfactorily performed in accordance with any
                and all applicable legislation from time to time in force
                (including, but not limited to, the GDPR) and any best practice
            ...
            <li className={styles.listItem}>
              ...
              <div>
                ...
                Customer’s cost) to the Customer in complying with its
                obligations under the GDPR with respect to the security of
                processing, the notification of Personal Data breaches, the
                conduct of data protection impact assessments, and in dealings
                with the ICO.
              </div>
            </li>
            <li className={styles.listItem}>
              ...
              <div>
                ...
                <ul className={styles.list}>
                  <li className={styles.listItem}>
                    <span>21.12.1.</span>
                    <div>
                      not process the Personal Data outside the European
                      Economic Area (all EU member states, plus Iceland,
                      Liechtenstein, and Norway) (“EEA”) other than the United
                      Kingdom (which shall be permitted) without the prior
                      written consent of the Customer and, where the Customer
                      consents to such a transfer to a country that is outside
                      of the EEA, to comply with the obligations of Data
                      Processors under the provisions applicable to transfers of
                      Personal Data to third countries set out in Chapter 5 of
                      the GDPR by providing an adequate level of protection to
                      any Personal Data that is transferred and providing
                  ...
                  <li className={styles.listItem}>
                    ...
                    <div>
                      ...
                      obligations to the Customer or as may be required by law
                      (in which case, Astrosat shall inform the Customer of the
                      legal requirement in question before processing the
                      Personal Data for that purpose unless prohibited from
                      doing so by law);
                    </div>
                  </li>
                  <li className={styles.listItem}>
                    ...
                    <div>
                      ...
                      measures, and take all steps necessary to protect the
                      Personal Data against unauthorised or unlawful processing,
                  ...
                  <li className={styles.listItem}>
                    <span>21.12.5.</span>
                    <div>
                      make available to the Customer any and all such
                      information as is reasonably required and necessary to
                      demonstrate Astrosat’s compliance with the GDPR; and
                    </div>
                  </li>
                  <li className={styles.listItem}>
                    <span>21.12.6.</span>
                    <div>
                      ...
                      anything that infringes the GDPR or the Privacy
                      Legislation
                    </div>
                  </li>
                </ul>
            ...
            <li className={styles.listItem}>
              ...
              <div>
                ...
                complying with its obligations under the GDPR. In particular,
                the following shall apply to data subject access requests,
              ...
              <div>
                ...
                <ul className={styles.list}>
                  ...
                  <li className={styles.listItem}>
                    <span>21.14.2.</span>
                    <div>
                      any other complaint or request relating to the processing
            ...
            <li className={styles.listItem}>
              ...
              <div>
                ...
                Customer and assist as required in relation to any subject
                access request, complaint, or other request, including by:
                <ul className={styles.list}>
                  <li className={styles.listItem}>
                    <span>21.15.1.</span>
                    <div>
                      providing the Customer with full details of the complaint
                      or request;
                    </div>
                  </li>
                  <li className={styles.listItem}>
                    <span>21.15.2.</span>
                    <div>
                      providing the necessary information and assistance in
                      order to comply with a subject access request;
                    </div>
                  </li>
                  <li className={styles.listItem}>
                    <span>21.15.3.</span>
                  ...
                  <li className={styles.listItem}>
                    <span>21.15.4.</span>
                    <div>
                      providing the Customer with any other information
            ...
            <li className={styles.listItem}>
              <span>21.16.</span>
              <div>
                Astrosat shall notify the Customer immediately if it becomes
                aware of any form of Personal Data breach, including any
                unauthorised or unlawful processing, loss of, damage to, or
                destruction of any of the Personal Data.
              </div>
            </li>
            <li className={styles.listItem}>
              <span>21.17.</span>
              ...
              <div>
                ...
                <ul className={styles.list}>
                  <li className={styles.listItem}>
                    <span>21.18.1.</span>
                    <div>
                      only to the extent that the same results from Astrosat’s
                      or a Sub-Processor’s breach of this Agreement; and
                    </div>
                  </li>
                  <li className={styles.listItem}>
                    <span>21.18.2.</span>
                    <div>
                      not to the extent that the same is or are contributed to
                      by any breach of this Agreement by the Customer.
                    </div>
                  </li>
                </ul>
              </div>
            ...
            <li className={styles.listItem}>
              <span>21.19.</span>
              <div>
                The Customer shall not be entitled to claim back from Astrosat
                or a Sub-Processor any sums paid in compensation by the Customer
                in respect of any damage to the extent that the Customer is
                liable to indemnify Astrosat or Sub-Processor under sub-Clause
                21.17.
              </div>
            </li>
            <li className={styles.listItem}>
              ...
              <div>
                ...
                shall relieve either party of, or otherwise affect, the
                liability of either party to any data subject, or for any other
                breach of that party’s direct obligations under the GDPR.
                Furthermore, Astrosat hereby acknowledges that it shall remain
                subject to the authority of the ICO and shall co-operate fully
                therewith, as required, and that failure to comply with its
                obligations as a Data Processor under the GDPR may render it
              ...
              <div>
                ...
                <ul className={styles.list}>
                  <li className={styles.listItem}>
                    <span>21.21.1.</span>
                    <div>
                      enter into a Sub-Processing Agreement with the
                      Sub-Processor which shall impose upon the Sub-Processor
                      the same or similar obligations as are imposed upon
                      Astrosat by this Agreement;
                    </div>
                  </li>
                  <li className={styles.listItem}>
                    <span>21.21.2.</span>
                    <div>
                      ...
                      obligations under the Sub-Processing Agreement and the
                      GDPR; and
                    </div>
                  </li>
                  <li className={styles.listItem}>
                    ...
                    <div>
                      ...
                      Sub-Processor’s obligations to the extent the
                      Sub-Processor fails to fulfil their data protection
                      obligations.
                    </div>
                  </li>
                </ul>
            ...
            <li className={styles.listItem}>
              ...
              <div>
                ...
                written direction of the Customer, delete or return Personal
                Data and copies thereof to the Customer on termination of this
                Agreement unless required by applicable law to store the
                Personal Data (and for these purposes the term “delete” shall
            ...
            <li className={styles.listItem}>
              ...
              <div>
                ...
                information to demonstrate its compliance with this Clause 21
                and immediately inform the Customer if, in the opinion of
                Astrosat, its instruction infringes the DPA or GDPR or
                applicable laws.
              </div>
            </li>
          </ul>
          ...
          <ul className={styles.list}>
            <li className={styles.listItem}>
              ...
              <div>
                ...
                share data which includes Personal Data for example to improve
                and enhance User experience and (2) to perform and/or improve
                the Services and (3) to obtain relevant marketing, demographic,
            ...
            <li className={styles.listItem}>
              <span>22.4.</span>
              <div>
                Each party shall appoint a data protection officer and/or at
                least one other of its representatives as a point of contact for
                all issues relating to the sharing of the Shared Personal Data
                and the GDPR (including, but not limited to, compliance,
                training, and the handling of Personal Data breaches).
              </div>
            </li>
            <li className={styles.listItem}>
              <span>22.5.</span>
            ...
            <li className={styles.listItem}>
              <span>22.7.</span>
              <div>
                Each party shall ensure that the Shared Personal Data is
                accurate and up-to-date prior to its disclosure to the other
                party.
              </div>
            </li>
            <li className={styles.listItem}>
              <span>22.8.</span>
              <div>
                The parties shall use compatible technology for the processing
                of the Shared Personal Data in order to preserve accuracy.
              </div>
            </li>
            <li className={styles.listItem}>
              <span>22.9.</span>
              <div>
                Both parties shall at all times during the Term process the
                Shared Personal Data fairly and lawfully.
              </div>
            </li>
            <li className={styles.listItem}>
              <span>22.10.</span>
            ...
            <li className={styles.listItem}>
              ...
              <div>
                ...
                notices and consents in order to enable the sharing of the
                Shared Personal Data under this Agreement. In particular, the
                parties shall ensure that data subjects are provided with clear
                and sufficient information about the following:
                <ul className={styles.list}>
                  <li className={styles.listItem}>
                    <span>21.11.1.</span>
                    <div>
                  ...
                  <li className={styles.listItem}>
                    <span>21.11.2.</span>
                    <div>
                      the legal basis upon which it is relying for such
                      purposes;
                    </div>
                  </li>
                  <li className={styles.listItem}>
                    <span>21.11.3.</span>
                    <div>
                      the fact that their Personal Data is to be transferred to
                      a third party and sufficient detail about the transfer to
                  ...
                  <li className={styles.listItem}>
                    ...
                    <div>
                      ...
                      purpose of the transfer and any risks associated
                      therewith; and
                    </div>
                  </li>
                  <li className={styles.listItem}>
                    <span>21.11.5.</span>
                    <div>
                      all other information required under Article 13 of the
                      GDPR.
                    </div>
                  </li>
                </ul>
              ...
              <div>
                ...
                <ul className={styles.list}>
                  <li className={styles.listItem}>
                    <span>22.12.1.</span>
                    <div>
                      consulting with the other party with respect to
                      information and notices provided to data subjects relating
                  ...
                  <li className={styles.listItem}>
                    <span>22.12.2.</span>
                    <div>
                      informing the other party about the receipt of data
                      subject access requests and providing reasonable
                  ...
                  <li className={styles.listItem}>
                    ...
                    <div>
                      ...
                      prior consultation with the other party, whenever
                      reasonably possible;
                    </div>
                  </li>
                  <li className={styles.listItem}>
                    <span>22.12.4.</span>
                    <div>
                      assisting the other party at the cost of the other party
                      in responding to any other data subject request.
                    </div>
                  </li>
                </ul>
              </div>
            ...
            <li className={styles.listItem}>
              ...
              <div>
                ...
                shared, and, if applicable, details of any further
                correspondence, telephone conversations, or meetings relating to
                the request.
              </div>
            </li>
            <li className={styles.listItem}>
            ...
            <li className={styles.listItem}>
              <span>22.15.</span>
              <div>
                In the event that any statutory or similar retention periods
                apply to any of the Shared Personal Data, the relevant Personal
                Data shall be retained by the relevant party in accordance
                therewith.
              </div>
            </li>
            <li className={styles.listItem}>
              <span>22.16.</span>
              <div>
                The parties shall delete (or otherwise dispose of) or at a
                party’s option anonymise the Shared Personal Data (or the
                relevant part thereof) and any and all copies thereof or, on the
                written request of the other party, other than in the case of
                anonymised data, return it to the other disclosing party,
                subject to any legal requirement to retain any applicable
                ...
                <ul className={styles.list}>
                  ...
                  <li className={styles.listItem}>
                    ...
                    <div>
                      ...
                      longer necessary to retain the Shared Personal Data (or
                      the relevant part thereof) in light of the Stated
            ...
            <li className={styles.listItem}>
              ...
              <div>
                ...
                disposing of the data shall notify the other party of the same
                in writing, confirming that the Shared Personal Data has been
                deleted or disposed of or anonymised using methods compliant
                with the GDPR.
              </div>
            </li>
            <li className={styles.listItem}>
            ...
            <li className={styles.listItem}>
              ...
              <div>
                ...
                Processor, it shall remain liable to the other party for any
                acts and/or omissions of the third-party processor and it shall
                comply with Articles 28 and 30 of the GDPR.
              </div>
            </li>
            <li className={styles.listItem}>
              <span>22.21.</span>
              <div>
                ...
                <ul className={styles.list}>
                  <li className={styles.listItem}>
                    <span>22.21.1.</span>
                    <div>
                      that party complies with the provisions of Article 26 of
                      the GDPR (where the third party is a joint controller);
                      and
                    </div>
                  </li>
                  <li className={styles.listItem}>
                    ...
                    <div>
                      ...
                      the GDPR; or one of the derogations for specific
                      situations set out in Article 49 of the GDPR applies.
                    </div>
                  </li>
                </ul>
              </div>
            ...
            <li className={styles.listItem}>
              <span>22.22.</span>
              <div>
                A party shall transfer the Shared Personal Data to the other
                party using methods compliant with the GDPR.
              </div>
            </li>
            <li className={styles.listItem}>
              <span>22.23.</span>
              <div>
                ...
                technical and organisational measures as reviewed and approved
                by the other party, to protect against the unauthorised or
                unlawful processing of, and against the accidental loss or
                destruction of, or damage to, the Shared Personal Data, having
            ...
            <li className={styles.listItem}>
              <span>22.24.</span>
              <div>
                When putting appropriate technical and organisational measures
                in place, both parties shall ensure a level of security
                appropriate to the nature of the Shared Personal Data which is
                to be protected, and to the potential harm resulting from the
            ...
            <li className={styles.listItem}>
              ...
              <div>
                ...
                representatives by whom the Shared Personal Data is to be
                handled and processed are appropriately trained to do so in
                accordance with the GDPR and with the requisite technical and
            ...
            <li className={styles.listItem}>
              ...
              <div>
                ...
                Representatives and that are same as the obligations imposed
                upon the parties by this Agreement.
              </div>
            </li>
            <li className={styles.listItem}>
              <span>22.28.</span>
              <div>
                ...
                the ICO concerning the processing of Shared Personal Data
                against either or both parties, the parties will inform each
                other about any such disputes or claims and will cooperate with
            ...
            <li className={styles.listItem}>
              ...
              <div>
                ...
                by the supervisory authority. If they do participate in the
                ...
                other dispute resolution proceedings developed for data
                protection disputes.
              </div>
            </li>
          </ul>
        ...
        <div className={styles.description}>
          <ul className={styles.list}>
            <li className={styles.listItem}>
              <span>23.1.</span>
              <div>
                The Customer hereby acknowledges that upon submitting Feedback
                to Astrosat, the Customer automatically grants to Astrosat a
                worldwide, perpetual, irrevocable, royalty free licence to use
                that Feedback in any way Astrosat deems appropriate including,
                but not limited to:
                <ul className={styles.list}>
                  <li className={styles.listItem}>
                    <span>23.1.1.</span>
          ...
          <ul className={styles.list}>
            <li className={styles.listItem}>
              ...
              <div>
                ...
                Order. Each Change Order shall detail the requested changes to
                the applicable task, responsibility, duty, budget, work
                programme or other matter. The Change Order will become
                effective upon the execution of the Change Order by both parties
                and will include a specified period of time (as agreed upon by
                the parties) within which Astrosat will implement the changes
                and any increase in price.
              </div>
            </li>
            <li className={styles.listItem}>
              <span>24.2.</span>
              <div>
                ...
                considering a Change Order requested by the other party.
                Astrosat reserves the right to postpone effecting material
                changes in the scope of Professional Services until such time as
      ...
      <h1 className={styles.title}>PART FOUR – DEFINITIONS.</h1>
      <div className={styles.section}>
          ...
          <ul className={styles.list}>
            ...
            <li className={styles.listItem}>
              ...
              <div>
                ...
                means a written statement signed by the parties recording any
                (a) change in the details of an Order Form, or (b) change in the
                assumptions upon which the Order Form is based (including, but
                not limited to, changes in an agreed starting date for a
                Subscription or Professional Services or suspension of the
                services by the Customer or (c) any changes in the fees, costs
                and/or time lines;
              </div>
            </li>
            <li className={styles.listItem}>
              ...
              <div>
                ...
                information that is proprietary or confidential which either
                party directly or indirectly discloses, or makes available, to
                the other, including but not limited to, the existence and terms
                of this Agreement, all confidential or proprietary information
                relating to the business, affairs, operations, processes,
                product information, know-how, technical information, designs,
                trade secrets or software and/or Intellectual Property of the
            ...
            <li className={styles.listItem}>
              ...
              <div>
                ...
                part of the Subscription Services or the Platform; BUT excluding
                User Content;
              </div>
            </li>
            <li className={styles.listItem}>
            ...
            <li className={styles.listItem}>
              ...
              <div>
                ...
                provided electronically by Astrosat for use with the
                Subscription Services, as periodically updated;
              </div>
            </li>
            <li className={styles.listItem}>
              <span>26.9.</span>
            ...
            <li className={styles.listItem}>
              ...
              <div>
                ...
                the Customer and Users provide regarding any products or
                services owned or supplied by Astrosat or its Affiliates;
              </div>
            </li>
            <li className={styles.listItem}>
              <span>26.11.</span>
              <div>
                ...
                control of Astrosat which shall include (but shall not be
                limited to) acts of God, perils of the sea or air, fire, flood,
                drought, explosion, sabotage, accident, embargo, riot, civil
                commotion, including acts of local government and parliamentary
                authority; inability to supply the Subscription Services and or
                the Professional Services, materials, breakdown of Local
                Equipment and labour disputes of whatever nature and for
                whatever cause arising including (but without prejudice to the
                generality of the foregoing) work to rule, overtime bars,
            ...
            <li className={styles.listItem}>
              ...
              <div>
                ...
                supplemented or adopted into United Kingdom Legislation from
                time to time;
              </div>
            </li>
            <li className={styles.listItem}>
            ...
            <li className={styles.listItem}>
              ...
              <div>
                ...
                enters liquidation, or a winding up petition is presented
                against the company; (b) has a receiver, liquidator,
                administrator, trustee or an individual with a similar role
                appointed over any of its assets; (c) proposes to make any
                arrangements with its creditors or passes a resolution to place
                the company into liquidation; or (d) suffers an event which,
                under the law of a different country, is equivalent to any of
                the previously specified acts or events;
              </div>
            </li>
            <li className={styles.listItem}>
              <span>26.16.</span>
            ...
            <li className={styles.listItem}>
              ...
              <div>
                ...
                and/or licensed by the Customer in terms of this Agreement and
                any additional conditions pertaining thereto substantially in
                the form comprising PART SIX of this Agreement;
              </div>
            </li>
            <li className={styles.listItem}>
              <span>26.19.</span>
            ...
            <li className={styles.listItem}>
              ...
              <div>
                ...
                of which is located here https://app.orbis.astrosat.net/terms;
              </div>
            </li>
            <li className={styles.listItem}>
              <span>26.22.</span>
              <div>
                ...
                consulting, development and other professional services
                identified on an Order Form but does not include the
            ...
            <li className={styles.listItem}>
              <span>26.24.</span>
              <div>
                <strong>“SLA”</strong> means a Service Level Agreement in the
                form set out in PART FIVE of this Agreement;
              </div>
            </li>
            <li className={styles.listItem}>
              <span>26.25.</span>
              <div>
                ...
                Platform and the Subscription Services as Updated and Upgraded
                from time to time;
              </div>
            </li>
            <li className={styles.listItem}>
            ...
            <li className={styles.listItem}>
              <span>26.28.</span>
              <div>
                <strong>“Subscription Services”</strong> means the hosted
                Customer experience solutions identified in an Order Form, and
                any modifications periodically made by Astrosat, but does not
            ...
            <li className={styles.listItem}>
              ...
              <div>
                ...
                during which Astrosat is required to provide the Customer with
                the Subscription Services as specified in the relevant Order
                Form;
              </div>
            </li>
            <li className={styles.listItem}>
            ...
            <li className={styles.listItem}>
              ...
              <div>
                ...
                Subscription Services and has been uploaded by a User;
              </div>
            </li>
            <li className={styles.listItem}>
              <span>26.35.</span>
              <div>
                <strong>“User Site”</strong> means a partition/tenancy/instance
                on the Platform created by Astrosat for the Customer and/or User
                or Users accessing the Subscription Services which shall contain
                User Content and shall be hosted on the Platform;
              </div>
            </li>
            <li className={styles.listItem}>
              <span>26.36.</span>
              <div>
                <strong>“Working Day”</strong> means any day (1) which is
                neither a Saturday or a Sunday or a public holiday in any part
                of the United Kingdom and (2) upon which the Bank of England is
                open for business.
              </div>
            </li>
          </ul>
      ...
      <h1 className={styles.title}>PART FIVE – SLA.</h1>
      <div className={styles.section}>
        <h2 className={styles.textSectionHeader}>
            ...
            <tbody>
              <tr>
                ...
                <td className={styles.td}>
                  To be made available to Users 24/7
                </td>
              ...
              <tr>
                ...
                <td className={styles.td}>
                  Astrosat will respond within defined service levels (see
                  below)
                </td>
                <td className={styles.td}>99</td>
              </tr>
          ...
          <table className={styles.table}>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td className={styles.td}>
                  On Demand Professional services requests for installations
                  etc.
                </td>
                <td className={styles.td}>8hrs</td>
                ...
                <ul className={styles.list}>
                  <li className={styles.listItem}>
                    ...
                    <div>
                      ...
                      proof of concept, Astrosat will appoint a dedicated
                      account manager who will be the first and primary point of
                  ...
                  <li className={styles.listItem}>
                    <span>3.1.2.</span>
                    <div>
                      For software issues, the Customer can raise a support
                      ticket to contact the Astrosat Help Desk which is
                      available at{' '}
                  ...
                  <li className={styles.listItem}>
                    ...
                    <div>
                      ...
                      the problem. A support technician will be assigned and
                      will attempt to solve a problem immediately, or as soon
                      thereafter as possible. When appropriate, the support
                      technician will give an estimate of how long it will take
                      to resolve. The technician will do their best to keep the
                  ...
                  <li className={styles.listItem}>
                    ...
                    <div>
                      ...
                      communications infrastructure and provide adequate
                      broadband facilities for on-line problem resolution.
                      Astrosat will work with the Customer’s hardware supplier
                      where necessary to ensure that remote support facilities
                      are setup according to requirements.
                    </div>
                  </li>
                  <li className={styles.listItem}>
                    <span>3.1.5.</span>
                  ...
                  <li className={styles.listItem}>
                    ...
                    <div>
                      ...
                      support facility. Astrosat does not support or warrant
                      your Local Equipment, or any other system or service that
                      you subscribe to. Its sole purpose is to support the
                      Astrosat Software only. Anything else is strictly the
                    ...
                    <div>
                      ...
                      <ul className={styles.list}>
                        <li className={styles.listItem}>
                          <span>3.1.7.1.</span>
                          <div>
                            Astrosat will maintain a help desk staffed by
                        ...
                        <li className={styles.listItem}>
                          <span>3.1.7.3.</span>
                          <div>
                            All requests are logged and prioritised, against
                            this priority Astrosat will respond to Customer/User
                            requests.
                          </div>
                        </li>
                        <li className={styles.listItem}>
              ...
              <div>
                <ul className={styles.list}>
                  ...
                  <li className={styles.listItem}>
                    <span>3.2.6.</span>
                    <div>
                      Provision of Information on availability of new versions
                  ...
                  <li className={styles.listItem}>
                    <span>3.2.7.</span>
                    <div>
                      Provision Consultancy advice (chargeable at agreed rates
                      may apply where appropriate) on Software development,
                    </div>
                  </li>
                  <li className={styles.listItem}>
                    <span>3.2.8.</span>
                    <div>
                      enhancements and modifications, together with estimates
                      for the same.
                    </div>
                  </li>
                  <li className={styles.listItem}>
      ...
      <h1 className={styles.title}>PART SIX – ORDER FORM</h1>
      <div className={styles.description}>
        <strong>
          The following Order Form is a template to be used and completed each
          time the Customer wishes to order new Subscription or Professional
          Services and the terms have been agreed between the parties.
        </strong>
      </div>
      <div className={styles.description}>
        ...
        Kirk, 200 High Street, Musselburgh EH21 7DX (<strong>“Astrosat”</strong>
        ) and [ ], (<strong>“the Customer”</strong>) and relates to the Services
        Agreement entered into between Astrosat and the Customer dated xxxxx
      ...
      <div className={styles.description}>
        ...
        <ul className={styles.list}>
          <li className={styles.listItem}>
            <span>1.</span>
            <div>
              This document constitutes an "Order Form" under the Agreement, and
      ...
      <div className={styles.section}>
        <h2 className={styles.textSectionHeader}>Subscription Services</h2>
        <div className={styles.description}>
          <ul className={styles.list}>
            <li className={styles.listItem}>
              <span>1.</span>
      ...
      <div className={styles.section}>
        <h2 className={styles.textSectionHeader}>Professional Services:</h2>
        <div className={styles.description}>
          <ul className={styles.list}>
            <li className={styles.listItem}>
              <span>1.</span>
              <div>
                ...
                <ul className={styles.list}>
                  ...
                  <li className={styles.listItem}>
                    <span>1.5.</span>
                    <div>Data/materials to be provided by Customer</div>
                  </li>
                  <li className={styles.listItem}>
                    <span>1.6.</span>
                    <div>Resources to be provided by Customer</div>
                  </li>
                </ul>
              </div>
            </li>
            <li className={styles.listItem}>
              ...
              <div>
                ...
                <ul className={styles.description}>
                  <li className={styles.listItem}>
                    <span>2.1.</span>
                    <div>Acceptance Testing Criteria</div>
                  </li>
                </ul>
              </div>
            </li>
            <li className={styles.listItem}>
              <span>3.</span>
              <div>Programme for delivery of Professional Services</div>
            </li>
            <li className={styles.listItem}>
              <span>4.</span>
              <div>Training:</div>
            ...
            <li className={styles.listItem}>
              <span>5.</span>
              <div>
                Provision of support and information to detect and clarify
                possible impositions and abuses of the Customer’s business
              </div>
            </li>
            <li className={styles.listItem}>
              <span>6.</span>
      ...
      <div className={styles.section}>
        <h2 className={styles.textSectionHeader}>Sub-contractors</h2>
        <div className={styles.description}>
          Any Affiliates and Sub-contractors used in delivering either the
          Subscription Services or the Professional Services must be approved by
          the Customer (such approval not to be unreasonably withheld) and shall
          be bound by all the terms and conditions of the Agreement and this
          Order Form. The use of any approved Sub-contractor or Affiliate by
          Astrosat will not absolve Astrosat of its contractual obligations to
          the Customer under the Agreement and Astrosat shall be liable to the
          Customer for the work carried out by any such Sub-contractor or
          Affiliate as if Astrosat had carried out such work itself. Any
          Sub-contractors or consultants (other than Astrosat’s Affiliates) that
          will be used by Astrosat in performing the Services are listed below:
        </div>
        <div className={styles.description}>
          [Specify all Sub-contractors and Affiliates to be used in delivering
          either the Subscription Services or the Professional Services]
        </div>
      </div>
      <div className={styles.section}>
        <h2 className={styles.textSectionHeader}>Special Conditions:</h2>
      ...
      <table className={styles.table}>
        <thead>
          <tr>
            <td className={styles.td}>
              <strong>Stevenson Astrosat Limited</strong> By:
            </td>
            <td className={styles.td}>
              <strong>[ ].</strong> By:
            </td>
        ...
        <tbody>
          <tr>
            <td className={styles.td}>_ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _</td>
            <td className={styles.td}>_ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _ _</td>
          </tr>
          <tr>
      ...
      <h1 className={styles.title}>PART SEVEN – EULA</h1>
      <div className={styles.section}>
      ...
      <h1 className={styles.title}>PART 2 - DEFINITIONS</h1>
      <div className={styles.section}>
      ...
      <h1 className={styles.title}>SCHEDULE 1</h1>
